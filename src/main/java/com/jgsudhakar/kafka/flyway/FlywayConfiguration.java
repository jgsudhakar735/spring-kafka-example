 ...
 * 
 */
package com.jgsudhakar.kafka.flyway;
...
public class FlywayConfiguration extends Flyway{
	 ...
	 */
	private final String TABLE_NAME= "KAFKA_VERSION_HISTORY";
	...
	public void version()  {
	      ...
	      try {
		         ...
		         setBaselineDescription("<< KAFKA API BASE LINE SCRIPT >>"); // override Default Baseline Desc
